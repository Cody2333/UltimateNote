...
public class CircleIndicatorView extends View {
    ...
    private void init(Context context) {
        ...
        activeIndicatorPaint.setColor(context.getResources().getColor(R.color.active_indicator));
        activeIndicatorPaint.setAntiAlias(true);
        inactiveIndicatorPaint = new Paint();
        inactiveIndicatorPaint.setColor(context.getResources().getColor(R.color.inactive_indicator));
    ...
    public void setInactiveIndicatorColor(@ColorRes int color) {
        inactiveIndicatorPaint.setColor(context.getResources().getColor(color));

        invalidate();
    }

    public void setActiveIndicatorColor(@ColorRes int color) {
        activeIndicatorPaint.setColor(context.getResources().getColor(color));
